...
from code_.networks.mobile_netv2 import conv_blocks as ops, mobilenet as lib
...
V2_DEF = dict(
    ...
    spec=[
        ...
        # Cifar:  https://github.com/yumaloop/mobilenetV2-cifar/blob/master/models/mobilenet_v2.py
        # op(slim.conv2d, stride=2, num_outputs=32, kernel_size=[3, 3]),
...
def mobilenet(input_tensor,
              ...
              divisible_by=None,
              activation_fn=None,
              dropout_keep_prob=0.8,  # @  don't know how to access scope
              **kwargs):
